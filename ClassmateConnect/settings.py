"""
Django settings for ClassmateConnect project.
...
SECRET_KEY = 'd367d8339@5=23$07fxm5zd7-^r*xn8eht9w!do*0jl_9sr$dy'
...
ROOT_URLCONF = 'ClassmateConnect.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates'),
                 os.path.join(BASE_DIR, 'connect_app/templates'),
                 ]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
...
WSGI_APPLICATION = 'ClassmateConnect.wsgi.application'
